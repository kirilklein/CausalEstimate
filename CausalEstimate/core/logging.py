...
def log_sample_stats(
    ...
    sample_table = compute_treatment_outcome_table(df=df, treatment_col=treatment_col, outcome_col=outcome_col)
...
def log_initial_stats(df: pd.DataFrame, treatment_col: str, outcome_col: str, ps_col: str):
