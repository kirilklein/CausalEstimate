import unittest
from pycausal.simulation.binary_simulation import simulate_binary_data, compute_ATE_theoretical_from_data, compute_ATE_theoretical_from_model
...
class TestSimulation(unittest.TestCase):
    ...
    def test_ATE_theoretical(self):
        ...
        self.assertAlmostEqual(ate_data, ate_model, delta=0.05)  # Example expected ATE value
